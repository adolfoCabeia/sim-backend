...
export async function bibliotecaJuridicaRoutes(fastify: FastifyInstance) {
  fastify.post<{ Body: CriarDiplomaInput }>(
    "/biblioteca-juridica",
    {
      ...
      preHandler: [fastify.authenticate, requirePermission("juridico:update"), validateBody(criarDiplomaSchema)],
    },
  ...
  fastify.get<{ Querystring: PesquisarDiplomasQuery }>(
    "/biblioteca-juridica",
    { ...docs.pesquisarDiplomasDocs, preHandler: [fastify.authenticate, requirePermission("juridico:read")] },
    controller.pesquisarController
  );

  fastify.get<{ Params: { id: string } }>(
    "/biblioteca-juridica/:id",
    { ...docs.obterDiplomaDocs, preHandler: [fastify.authenticate, requirePermission("juridico:read")] },
  ...
  fastify.patch<{ Params: { id: string }; Body: AtualizarDiplomaInput }>(
    "/biblioteca-juridica/:id",
    {
      ...
      preHandler: [fastify.authenticate, requirePermission("juridico:update"), validateBody(atualizarDiplomaSchema)],
    },
  ...
  fastify.delete<{ Params: { id: string } }>(
    "/biblioteca-juridica/:id",
    { ...docs.removerDiplomaDocs, preHandler: [fastify.authenticate, requirePermission("juridico:update")] },
